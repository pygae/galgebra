...
if GAdir.GA == 'GA':
    ...
    from sympy.galgebra.GAPrint import GA_Printer,GA_LatexPrinter,enhance_print,xdvi,latex
    from sympy.galgebra.Vector import Vector
    from sympy.galgebra.GAdebug import ostr,oprint
    from sympy.galgebra.GAStringArrays import fct_sym_array,str_array,str_combinations,symbol_array
    from sympy.galgebra.GAsympy import linear_expand,bilinear_product,linear_projection,\
                                        non_scalar_projection,nc_substitue,coef_function,\
                                        half_angle_reduce,get_commutative_coef
