...
\begin{lstlisting}
\T{MV.setup(basis, metric=None, coords=None, rframe=False,\
...
\begin{quote}
   ...
   determine the sign of the expression so that a \T{hint} is needed to determine if the program should calculate $\sqrt{MM^{\R}}$ or
   $\sqrt{-MM^{\R}}$.
\end{quote}
