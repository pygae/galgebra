...
.. topic:: Abstract
   ...
   module and the mathematics behind it is at `GA <../../pdf/GA.pdf>`_.
...
A geometric algebra is instantiated with
   ...
   *sympy.galgebra.Ga(basis, g=None, coords=None, norm=False, debug=False, X=None)*
   ...
   The *basis* and *g* parameters were described in `GA[page 10] <../../pdf/GA.pdf#page=11>`_.
   ...
   *Ga.grads()*
   ...
   `GA[page 23] <../../pdf/GA.pdf#page=24>`_. Again
...
---------------------------
    ...
    *dFop*, *dBop*, *dFrop*, and *dBrop* are all multivector differential operators (again see 
    `GA[page 25] <../../pdf/GA.pdf#page=26>`_).
...
------------
    ...
    *Ga.sm(map,coords,root='e',norm=False)*
        ...
        *sph2d* of *sp3d* is a spherical surface of radius :math:`1`.  To take the sumanifold operation one step further
        ...
        basis vectors are not normalized the program output is `Submanifold <../../pysource/manifold_src.pdf>`_.

Linear Transformations
----------------------

    The mathematical background for linear transformations is in `GA[page 26] <../../pdf/GA.pdf#page=27>`_.  
    ...
    *f* is *True* or *False*. If *True* the symbolic coefficients of the general linear transformation are
    ...
    with output `Linear Transformation Instantiation <../../pysource/LtransInst.pdf>`_.
    ...
    *Lt.matrix()*
    ...
    The ouput of *Ltrans.py* is `Linear Transformations <../../pysource/Ltrans.pdf>`_.

Differential Operators
----------------------

    For the mathematical treatment of linear mulivector differential operators `GA[page 23] <../../pdf/GA.pdf#page=24>`_.
    ...
    The output of this code is `Differential Operators <../../pysource/dop.pdf>`_.

Instantiating a Multi-linear Functions (Tensors)
------------------------------------------------

The mathematical background for multi-linear functions is in `GA[page 27] <../../pdf/GA.pdf#page=28>`_.
...
See `GA[page 27] <../../pdf/GA.pdf#page=28>`_ for the mathematical description of each operation.
    ...
    *self.cderiv()*
        ...
        The operation performed is defined in `GA[page 30] <../../pdf/GA.pdf#page=31>`_.
...
--------------
    ...
    *xpdf(filename=None,debug=False,paper=(14,11),crop=False)*
    ...
    The output of the code is `*LaTeX* output example <../../pysource/print_example1.pdf>`_ is displayed
    ...
    and the latex displayed output is (:math:`f` is a scalar function) `LaTeX output for derivatives <../../pysource/print_example2.pdf>`_.
...
The output of the code is `BACCAB <../../pysource/baccab.pdf>`_
...
and not as ":math:`E\wedge {2} =`".  The output is in `Reciprocal Frame <../../pysource/recp_frame.pdf>`_.
...
overridden by the *\%* directive).  The output of the code is in `Lorentz Transformation <../../pysource/lorentz_trans.pdf>`_.
...
the results of the adjoint test for both cases.  The output is in `Linear Transformation <../../pysource/Ltrans.pdf>`_.
...
Results of the code are in `Spherical Coordinates <../../pysource/spherical.pdf>`_. 
...
Code output is in `Maxwell's Equations <../../pysource/maxwell.pdf>`_.
...
of these equations is to setup a numerical solver for the Dirac equation.  The code output is in `Dirac Equation <../../pysource/dirac.pdf>`_.
...
derivatives of both tensors are caculated.  The results are in `Manifold <../../pysource/manifold.pdf>`_
